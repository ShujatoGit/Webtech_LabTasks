...
<body style="cursor:crosshair"><center>
   <form id="cna" action="../controller/NewAccountControl.php" method="post" name="cnaform" onsubmit="return Rcheck();" enctype="multipart/form-data">
      ...
      <fieldset>
         ...
         <table>
            <tr>
               <td colspan="3" id="lin1"><a href="RULES.html"><font color="blue">RULES of SpartanBank to create a new account</a></td>
            </tr>
            ...
            <tr><td colspan="3"><hr></td></tr>
            <tr>
               <td id="lin1"><a href="../SpartanBank.html">Go to Opening Page</a></td>
