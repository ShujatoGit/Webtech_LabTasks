<?php
	...
	$sql	=	 "SELECT * FROM `sb_userlist` WHERE id ='$_GET[userID]'";
...
<head>
   ...
   <script src="../controller/js/validateExistingUser.js" type="text/javascript" charset="utf-8"></script>
</head>

<body>
	<form action="../controller/ProfileUpdateControl.php" method="post" onsubmit="return Ucheck();">
		<table border=1>
			<tr>
			...
			<tr>
	         <td><center><a href="banker_Profile.php"> Back to PROFILE</a></td>
			</tr>
